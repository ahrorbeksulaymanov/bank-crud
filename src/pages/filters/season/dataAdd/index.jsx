...
const AddSeason = () => {
  ...
  const match = useRouteMatch("/season-add/:id");
  ...
  useEffect(() => {
    if (match.params.id != 0) {
      ...
      axios({
        url: PATH_API + `/season/${match.params.id}`,
        method: "get",
        headers: {
        ...
        <div>
          ...
          >
            ...
            <Form.Item
              label="Fasl nomi"
              name="name"
              rules={[{ required: true, message: "Iltimos fasl nomini kiriting!" }]}
            >
              <Input type={'text'} placeholder="Fasl..." />
            </Form.Item>
